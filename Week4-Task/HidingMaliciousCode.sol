...
Initialize a new contract inside the constructor (Foo)
Make the address of external contract public so that the code of the external contract can be reviewed (Bar public bar)
*/
contract Foo {
    Bar public bar;
